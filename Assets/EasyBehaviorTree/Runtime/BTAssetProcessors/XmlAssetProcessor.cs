...
namespace AillieoUtils.EasyBehaviorTree
{
    public class XmlAssetProcessor : IBTAssetProcessor
    {
        ...
        {
            XmlDocument xmlDoc = new XmlDocument();
            xmlDoc.AppendChild(BTNodeToXmlElement(xmlDoc, behaviorTree.behaviorTreeStructure.root));
        ...
        {
            XmlElement xmlEle = xmlDoc.CreateElement(node.nodeName);
