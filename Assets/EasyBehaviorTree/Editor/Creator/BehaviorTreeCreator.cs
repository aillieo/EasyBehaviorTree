...
namespace AillieoUtils.EasyBehaviorTree.Creator
{
    public class BehaviorTreeCreator
    {
        ...
        [MenuItem("Assets/AillieoUtils/EasyBehaviorTree/CreateTreeAsset", false, 0)]
        //[MenuItem("GameObject/AillieoUtils/EasyBehaviorTree/CreateTreeAsset", false, 0)]
        ...
        [MenuItem("Assets/AillieoUtils/EasyBehaviorTree/CreateTreeAsset", true, 0)]
        //[MenuItem("GameObject/AillieoUtils/EasyBehaviorTree/CreateTreeAsset", true, 0)]
        ...
        private bool Validate()
        {
            ...
            foreach(var pair in nodeCreateInfo)
            {
                ...
                {
                    valid = false;
                    Debug.LogError(string.Format("{0}: {1}({2})", error,pair.Value.nodeName,pair.Key.gameObject.name), pair.Key.gameObject);
                }
            }
